...
export function BootcampWhatsappFloat() {
  ...
  return (
    <a
      ...
      className={cn(
        'fixed bottom-20 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-pill bg-bootcamp-yellow text-bootcamp-black shadow-card transition-all duration-300 ease-out hover:scale-105 active:scale-95 md:bottom-24 md:right-8',
